...
const Notification:React.FC<NotificationProps> = ({notification}) => {
    ...
    return (
        <div className={`flex relative border-2 p-3 shadow-md ${notification.notification.notificationType === NotificationType.APPOINTMENT_CANCELLED || notification.notification.notificationType === NotificationType.QUEUEING_CLOSE?'shadow-red-300':'shadow-green-300' }`}>
